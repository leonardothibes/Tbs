...
use \Tbs\Helper\Phone\Eight as phone;
 ...
 * @copyright Copyright (c) The Authors
 */
class EightTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var \Tbs\Helper\Phone\Eight
     */
    ...
    {
        $rs = phone::mask('9912345678');
        $this->assertInternalType('string', $rs);
        $this->assertEquals('(99) 1234-5678', $rs);
    }
    ...
    {
        $rs = phone::unMask('(99) 1234-5678');
        $this->assertInternalType('string', $rs);
        $this->assertEquals('9912345678', $rs);
    }
    ...
    {
        $rs = phone::unMaskToArray('(99) 1234-5678');
        ...
        $this->assertEquals('12345678', $rs['phone']);
    }
}
