...
/**
 * Helper functions for phones of 9 digits.
 *
 * @package Tbs\Helper
 * @author Leonardo Thibes <eu@leonardothibes.com>
 * @copyright Copyright (c) The Authors
 */
class Nine implements M, V
{
    /**
    ...
    {
        return (bool)preg_match('/^\([0-9]{2}\)\s[0-9]{5}\-[0-9]{4}$/', $phone);
    }
    ...
    */
    ...
    {
        return sprintf('(%d) %d-%d', substr($phone, 0, 2), substr($phone, 2, 5), substr($phone, 7, 4));
    }
